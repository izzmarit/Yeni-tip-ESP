...
public:
    ...
    // Motor test fonksiyonu - YENİ
    void performMotorTest(uint32_t durationSeconds);

    // YENİ EKLEME: Storage referansını ayarlama fonksiyonu
