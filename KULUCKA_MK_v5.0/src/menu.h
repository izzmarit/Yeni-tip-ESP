...
enum MenuState {
    ...
    MENU_PID_MODE,          // PID modu seçimi (Manuel/Otomatik)
    ...
    MENU_CALIBRATION_TEMP,  // Sıcaklık kalibrasyon ekranı
    MENU_CALIBRATION_HUMID, // Nem kalibrasyon ekranı
...
public:
    ...
    // **EKLEME: Menü kaydırma offset değerini al**
    ...
    // PID durumu için menü öğelerini güncelle
...
private:
    ...
    // **EKLEME: Menü kaydırma offset'ini güncelle**
