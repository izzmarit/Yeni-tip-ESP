...
void MenuManager::_handleTimeAdjustment(JoystickDirection direction) {
    switch (direction) {
        ...
        case JOYSTICK_LEFT:
            if (_timeField == 0) {
                // Sol tuşta saat alanındayken geri dön
                _currentState = _previousState;
                _menuChanged = true;
            } else {
        ...
        case JOYSTICK_RIGHT:
            if (_timeField == 0) {
                ...
                // Dakika alanındayken sağ tuş kaydet işlevi görsün
                // Bu main.cpp'de işlenecek
            }
            break;
...
void MenuManager::_handleDateAdjustment(JoystickDirection direction) {
    ...
    switch (direction) {
        ...
        case JOYSTICK_LEFT:
            if (_dateField == 0) {
                // Sol tuşta gün alanındayken geri dön
                _currentState = _previousState;
                _menuChanged = true;
            } else {
        ...
        case JOYSTICK_RIGHT:
            if (_dateField == 2) {
                // Yıl alanındayken sağ tuş kaydet işlevi görsün
                // Bu main.cpp'de işlenecek
            } else {
