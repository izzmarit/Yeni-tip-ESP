...
void MenuManager::_initializeMenuItems() {
    ...
    _mainMenuItems = {
        ...
        {"Alarm", MENU_ALARM},
        {"Sensor Degerleri", MENU_SENSOR_VALUES},
    ...
    _tempCalibrationItems = {
        {"Sensor 1 Sicaklik", MENU_CALIBRATION_TEMP_1},
        {"Sensor 2 Sicaklik", MENU_CALIBRATION_TEMP_2}
    };
    
    // Nem kalibrasyon alt menüsü öğeleri
    _humidCalibrationItems = {
        {"Sensor 1 Nem", MENU_CALIBRATION_HUMID_1},
        {"Sensor 2 Nem", MENU_CALIBRATION_HUMID_2}
    };
    
    // Alarm alt menüsü öğeleri
    _alarmItems = {
        {"Alarm Acik/Kapali", MENU_ALARM_ENABLE},
