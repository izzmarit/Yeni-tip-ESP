 ...
 * @version 1.5 - Alarm sistemi derleme hataları düzeltildi
 */

#include "menu.h"
#include "alarm.h"  // AlarmManager için gerekli
#include "pid.h"    // YENİ EKLENDİ: PIDController ve PIDMode için gerekli
...
void MenuManager::updatePIDMenuItems() {
    // External PID controller referansını al - DÜZELTME
    ...
    if (pidController.getPIDMode() != PID_MODE_MANUAL) {
        _pidItems.push_back({"Manuel PID Başlat", MENU_PID_MANUAL_START});
    }
