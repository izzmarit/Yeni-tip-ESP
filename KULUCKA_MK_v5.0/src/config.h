...
#define EEPROM_WRITE_DELAY 30000
#define EEPROM_MAX_CHANGES 3 // Maksimum değişiklik sayısı aşıldığında anında yazma
...
// FRAM Ayarları 
#ifndef USE_FRAM
#define USE_FRAM true                 // FRAM kullanımını etkinleştir
#endif

#define FRAM_ADDRESS 0x50             // MB85RC256V varsayılan I2C adresi
#define FRAM_SIZE 32768               // 32KB (256Kbit)
#define FRAM_WRITE_PROTECT_PIN -1     // WP pini kullanılmıyorsa -1
#define FRAM_VERIFICATION_CODE 0xFB85 // FRAM doğrulama kodu

// Storage seçimi
#define STORAGE_TYPE_EEPROM 0
#define STORAGE_TYPE_FRAM 1
#define SELECTED_STORAGE_TYPE STORAGE_TYPE_FRAM
...
// Gelişmiş Watchdog Ayarları
#define WDT_WARNING_THRESHOLD 3000    // 3 saniye uyarı eşiği
#define WDT_CRITICAL_TIMEOUT 5        // Kritik bölüm timeout (saniye)
#define WDT_EMERGENCY_TIMEOUT 60      // Acil durum timeout (saniye)

// Memory Pool Ayarları
#define JSON_POOL_SIZE 2048           // JSON buffer pool boyutu
#define WEB_RESPONSE_POOL_SIZE 4096   // Web response buffer boyutu

// Storage Thread Safety
#define STORAGE_LOCK_TIMEOUT 5000     // Storage lock timeout (ms)
#define STORAGE_MAX_RETRY 3           // Maksimum retry sayısı

// Enhanced Error Recovery
#define SENSOR_MAX_CONSECUTIVE_ERRORS 5    // Sensör max hata sayısı
#define WIFI_RECOVERY_INTERVAL 60000       // WiFi recovery interval (ms)
#define SYSTEM_HEALTH_CHECK_INTERVAL 30000 // System health check (ms)
