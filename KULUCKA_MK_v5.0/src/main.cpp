...
void handleValueAdjustment(JoystickDirection direction) {
    if (direction == JOYSTICK_PRESS) {
        ...
        bool criticalUpdate = true; // VARSAYILAN OLARAK TÜM DEĞİŞİKLİKLER KRİTİK
        ...
        switch (prevState) {
            case MENU_TEMPERATURE:
                ...
                storage.setTargetTemperature(value); // YENİ EKLENEN
            ...
            case MENU_HUMIDITY:
                ...
                storage.setTargetHumidity((uint8_t)value); // YENİ EKLENEN
                if (incubation.getIncubationType() == INCUBATION_MANUAL) {
...
void handleWifiParameterUpdate(String param, String value) {
    ...
    // Motor test komutu
        ...
        if (testDuration > 0 && testDuration <= 60) {
            ...
            return; // Test işlemi için kayıt yapma
        }
    }
    // Alarm ayarları
