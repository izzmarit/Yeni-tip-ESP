...
void updateSensors() {
    ...
    // WiFi durum verilerini güncelle - DÜZELTME: temp ve humid kullan
    wifiManager.updateStatusData(
        temp,  // currentTemp yerine temp
        humid, // currentHumid yerine humid
    ...
    // PID Mode durumunu ayrıca güncelle - KRİTİK EK
    ...
    if (needWatchdogFeed) {
     ...
     // Alarm durumu değişiklik tespiti - YENİ EKLENDİ
