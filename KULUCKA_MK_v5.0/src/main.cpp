...
void handleJoystick() {
    ...
    if (direction != JOYSTICK_NONE) {
        ...
        if (menuManager.isInValueAdjustScreen()) {
            if (direction == JOYSTICK_PRESS) {
                handleValueAdjustment(direction);
                       ...
                       direction == JOYSTICK_LEFT || direction == JOYSTICK_RIGHT) {
                // TÜM YÖNLERİ menuManager.update'e gönder
        ...
        MenuState terminalMenus[] = {
            ...
            MENU_WIFI_MODE, MENU_WIFI_SSID, MENU_WIFI_PASSWORD, MENU_WIFI_CONNECT  // WiFi menüleri eklendi
        };
