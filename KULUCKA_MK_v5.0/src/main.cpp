            ...
            case MENU_ALARM_ENABLE:
                {
                    ...
                    alarmManager.setAlarmsEnabled(!currentlyEnabled);
                    storage.setAlarmsEnabled(!currentlyEnabled);
                    storage.queueSave();
                    
                    String message = (!currentlyEnabled) ? "Alarmlar Acildi" : "Alarmlar Kapatildi";
                    display.showConfirmationMessage(message);
...
void handleWifiParameterUpdate(String param, String value) {
    ...
    // Alarm ayarları ve durum - GÜNCELLENDİ
