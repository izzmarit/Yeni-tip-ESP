...
void Display::showMenu(String menuItems[], int itemCount, int selectedItem) {
    ...
    // **DÜZELTME: Kaydırma offset'ini göz önünde bulundur**
    ...
    // **DÜZELTME: Menü listesi için uygun alan hesaplama**
    int menuStartY = 16;
    int menuEndY = SCREEN_HEIGHT - 16;
    int menuHeight = menuEndY - menuStartY;
    
    // **DÜZELTME: Maksimum görünebilir öğe sayısı**
    ...
    // **DÜZELTME: Sadece görünür aralıktaki öğeleri göster**
