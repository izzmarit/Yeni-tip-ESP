 ...
 * @version 1.4 - Android uygulaması ve alarm sistemi düzeltmeleri
 */
...
WiFiManager::WiFiManager() {
    ...
    // Motor ayarları - YENİ EKLENDİ
    _motorWaitTime = 120;
    _motorRunTime = 14;
    
    // Kalibrasyon ayarları - YENİ EKLENDİ
    _tempCalibration1 = 0.0;
    _tempCalibration2 = 0.0;
    _humidCalibration1 = 0.0;
    _humidCalibration2 = 0.0;
    
    // Manuel kuluçka ayarları - YENİ EKLENDİ
    _manualDevTemp = 37.5;
...
void WiFiManager::updateStatusData(float temperature, float humidity, bool heaterState, 
    ...
    if (_storage != nullptr) {
        ...
        // NOT: PID mode main.cpp'den setPidMode() ile güncellenecek - KRİTİK!
        // extern PIDController satırları KALDIRILDİ
...
// setPidMode fonksiyonu implementasyonu - YENİ EKLENDİ:
...
String WiFiManager::createAppData() {
    // Telefon uygulaması için genişletilmiş JSON verisi oluştur - DÜZELTME
    ...
    // Alarm verileri - DÜZELTME VE GENİŞLETME
    ...
    // Kalibrasyon verileri - YENİ EKLENDİ
    ...
    // Manuel kuluçka parametreleri - YENİ EKLENDİ
...
function updateStatus() {
  fetch('/api/status').then(response => response.json()).then(data => {
    ...
    // Alarm durumu gösterimi - YENİ EKLENDİ
...
String WiFiManager::_getStatusJson() {
    // Genişletilmiş JSON: Android uygulama için tüm veriler - DÜZELTME
    ...
    // PID ve alarm bilgileri - GENİŞLETME
    doc["pidMode"] = _pidMode;
    doc["pidKp"] = _pidKp;
    doc["pidKi"] = _pidKi;
    doc["pidKd"] = _pidKd;
    doc["alarmEnabled"] = _alarmEnabled; // ALARM DURUMU EKLEME
    doc["tempLowAlarm"] = _tempLowAlarm;
    doc["tempHighAlarm"] = _tempHighAlarm;
    doc["humidLowAlarm"] = _humidLowAlarm;
    doc["humidHighAlarm"] = _humidHighAlarm;
