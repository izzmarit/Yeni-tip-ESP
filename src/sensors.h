...
public:
    ...
    // Tek sensör kalibrasyon fonksiyonları - YENİ EKLENENLER
    void setTemperatureCalibrationSingle(uint8_t sensorIndex, float calibValue);
    void setHumidityCalibrationSingle(uint8_t sensorIndex, float calibValue);
