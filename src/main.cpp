            ...
            if (menuManager.isInTimeAdjustScreen() || menuManager.isInDateAdjustScreen()) {
                ...
                if (menuManager.isInTimeAdjustScreen()) {
                    if (direction == JOYSTICK_LEFT) {
                        if (menuManager.getTimeField() == 0) {
                            // İlk alanda sol tuş = geri çık
                        ...
                        if (menuManager.getTimeField() == 1) {
                            // Son alanda sağ tuş = kaydet (JOYSTICK_PRESS gibi işle)
